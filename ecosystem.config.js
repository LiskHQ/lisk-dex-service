...
module.exports = {
	apps: [
		...
		},
		{
			name: 'dex-base',
			script: 'app.js',
			cwd: './services/dex-base',
			pid_file: './pids/service_dex_base.pid',
			out_file: './logs/service_dex_base.log',
			error_file: './logs/service_dex_base.err',
			log_date_format: 'YYYY-MM-DD HH:mm:ss SSS',
			watch: false,
			kill_timeout: 10000,
			max_memory_restart: '150M',
		...
		},
		{
			name: 'dex-governance',
			script: 'app.js',
			cwd: './services/dex-governance',
			pid_file: './pids/service_dex_governance.pid',
			out_file: './logs/service_dex_governance.log',
			error_file: './logs/service_dex_governance.err',
			log_date_format: 'YYYY-MM-DD HH:mm:ss SSS',
			watch: false,
			kill_timeout: 10000,
			max_memory_restart: '150M',
		...
		},
		{
			...
			script: 'app.js',
			cwd: './services/dex-information',
			pid_file: './pids/service_dex_information.pid',
			out_file: './logs/service_dex_information.log',
			error_file: './logs/service_dex_information.err',
			log_date_format: 'YYYY-MM-DD HH:mm:ss SSS',
			watch: false,
			kill_timeout: 10000,
			max_memory_restart: '150M',
