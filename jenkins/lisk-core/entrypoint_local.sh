#!/bin/sh
LISK_CORE_BIN=lisk-dex-core
CONFIG_DIR=~/.lisk/lisk-dex-core/config/devnet
...
echo "Use this variable for Lisk DEX Service -> export LISK_CORE_WS=ws://${WS_HOST}:${WS_PORT}"

echo "Running Lisk Core: $(which lisk-dex-core)"
