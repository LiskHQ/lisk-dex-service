...
module.exports = {
	...
	tags: ['Prices'],
	params: {
		poolID: { optional: false, type: 'string', min: 1, max: 64, pattern: regex.POOL_ID },
		tokenAmount0: { optional: false, type: 'string', min: 0, pattern: regex.TOKEN_ID },
        tokenAmount1: { optional: false, type: 'string', min: 0, pattern: regex.TOKEN_ID },
        isZeroToOne: { optional: false, type: 'boolean', min: 0, pattern: regex.TOKEN_ID },
	},
	get schema() {
